        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4">
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl border border-minimal-border shadow-minimal-sm">
                <div className="text-center">
                    ...
                    <h2 className="mt-6 text-3xl font-bold text-minimal-text">Welcome Back</h2>
                    <p className="mt-2 text-sm text-minimal-muted">Enter your details to access your trips</p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center text-sm">
                        <span className="text-minimal-muted">Don't have an account? </span>
                        <Link to="/register" className="text-brand-800 font-bold hover:underline">Sign up</Link>
                    </div>
                </form>
            </div>
        </div>
