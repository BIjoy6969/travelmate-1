  ...
  return (
    <nav className="sticky top-0 z-[1000] w-full bg-white border-b border-minimal-border py-4 px-6 md:px-12 flex items-center justify-between">
      ...
      <div className="hidden lg:flex items-center gap-6">
        ...
        <Link to="/budget" className={`flex items-center gap-2 text-sm font-medium transition-colors ${isActive('/budget') ? 'text-brand-800' : 'text-minimal-muted hover:text-minimal-text'}`}>
          <Wallet size={16} />
          <span>Budget</span>
        </Link>
